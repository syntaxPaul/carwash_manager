...
const String washDeskSubscriptionRenewal =
    'Auto-renewable subscription, billed every 1 month until cancelled.';
...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
          ...
          ValueListenableBuilder<ManagerAccount?>(
            ...
            builder: (context, account, _) {
              ...
              final subtitle = account == null
                  ...
                  : account.hasAccess
                      ? '${account.trialDaysRemaining} trial day${account.trialDaysRemaining == 1 ? '' : 's'} left. Continued access uses the monthly auto-renewable subscription below.'
                      : 'Choose the monthly auto-renewable subscription below to keep recording washes, bookings, staff and daily totals.';
  ...
  String _subscribeLabel(BillingService billing) {
    ...
    if (price == null || price.trim().isEmpty) {
      return 'Subscribe for $managerSubscriptionPrice / month';
    }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const _PlanInfoRow(
            label: 'Trial',
            value: '$managerTrialDays-day free trial for new manager accounts.',
          ),
          if (isActive) ...[
            const SizedBox(height: 8),
            Text(
